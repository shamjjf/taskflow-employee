      ...
      <div className="sm:hidden mb-4">
        ...
        <div className="relative">
          <select
            ...
            className="w-full appearance-none bg-white border border-border rounded-md pl-3 pr-9 py-2.5 text-[13.5px] font-medium text-[#18181b] focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
          >
            {tabs.map((tab) => (
          ...
          <svg
            className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[#71717a]"
